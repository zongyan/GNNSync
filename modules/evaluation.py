    ...
    while l < maximumLayerWiseNum + 1:
        ...
        if data.attackMode == 1 or data.attackMode == 2: # attacking occurs
            ...
            for i in range(attackRadiusTest.shape[2]):
                ...
                np.savez(saveFile+'.npz', attackOffsetDistributed=attackOffsetDistributed, attackSkewDistributed=attackSkewDistributed, \
                ...
                mdic = {"attackOffsetDistributed": attackOffsetDistributed, \

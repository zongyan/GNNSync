...
// *              xx, China
// * 
// * Description: Data management module: creating trajectories for the problem 
// *              of time synchronisation and flocking in the UAVs swarm system
// *              
// * Functions:   normalizeData: normalize data along a specified axis
